      ...
      {membershipData.map((item, index) => {
        return (
          <SwiperSlide key={index}>
            <div className="border border-[#D6FE50] hover:bg-primary-300/80 transition-all duration-300 w-full max-w-sm xl:max-w-none mx-auto">
              <div className="py-5 px-[60px] border-b border-[#D6FE50]">
              ...
              <div className="py-[30px] px-[60px]">
                  ...
                  {item.benefits.map((item, index) => {
                    return (
                      <li key={index} className="flex items-center gap-2">
                        <item.icon className="text-[#D6FE50] text-lg" />
                        {item.text}
                      </li>
                    );
                  })}
                ...
                {/* price & button */}
                <p className="text-[#99b833] mb-8 flex gap-1 items-center">
